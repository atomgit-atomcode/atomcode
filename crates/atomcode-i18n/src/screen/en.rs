...
pub(super) fn en(msg: Msg<'_>) -> Cow<'static, str> {
    match msg {
        ...
        Msg::AskTypeSomething => "Type something.".into(),
        Msg::AskChatInstead => "Chat about this".into(),
        Msg::AskSubmit => "Submit".into(),
        Msg::AskNext => "Next".into(),
        Msg::AskReviewTitle => "Review your answers".into(),
        Msg::AskReviewReady => "Ready to submit your answers?".into(),
        Msg::AskReviewSend => "Submit answers".into(),
        Msg::AskReviewCancel => "Cancel".into(),
        ...
        Msg::BgPanelMoved => "Your conversation moved to the background — enter opens it · esc returns to it · ctrl+c twice quits".into(),
        Msg::BgPanelLooking => "Background sessions — enter opens one · esc returns here · ctrl+c twice quits".into(),
        Msg::BgGroupNeedsInput => "Needs input".into(),
        Msg::BgGroupWorking => "Working".into(),
        Msg::BgGroupCompleted => "Completed".into(),
        Msg::BgPanelEmpty => "no session in the background yet".into(),
        ...
        Msg::BgReplyWaiting => "this session is waiting for your answer — press Enter to open it".into(),
