...
pub(super) fn zh_cn(msg: Msg<'_>) -> Cow<'static, str> {
    match msg {
        ...
        Msg::CmdAboutCd => "换到另一个目录干活;会开一条新会话".into(),
        ...
        Msg::ClipboardHasNoText => "剪贴板里没有文字;`/paste 路径` 可以贴一个文件".into(),
        ...
        Msg::OnboardIntroLine2 => "这里三步：选界面语言、登录、看一眼配好了什么。".into(),
