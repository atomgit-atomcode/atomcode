...
pub(super) fn zh_cn(msg: Msg<'_>) -> Cow<'static, str> {
    match msg {
        ...
        Msg::CmdAboutRewind => "回到某一回合之前:对话、工作区或两者;不带参数则挑一个".into(),
        ...
        Msg::RewindPointAbout { turn, files } => format!("回合 {turn} · {files} 个文件改动").into(),
        Msg::RewindPickerHint => "回到哪一回合之前 · enter 回去".into(),
        Msg::RewindNoPoints => "还没有可以回去的回合".into(),
