...
const zh = {
  ...
  'sidebar.expandWorkspace': '展开工作区会话',
  'sidebar.collapseWorkspace': '收起工作区会话',
  'sidebar.timeNow': '刚刚',
  'sidebar.timeMinutes': '{n}分钟前',
  'sidebar.timeHours': '{n}小时前',
  ...
  'chat.kbdHintMobile': '回车换行 · 点击 ↑ 发送',
  'stats.counts': '{rounds} 轮 · {tools} 工具',
  'stats.duration': '耗时 {duration}',
  ...
  'tool.output': '输出',
  'todo.panel.title': '任务',
  'todo.panel.inProgress': '{n} 进行中',
  'todo.panel.pending': '{n} 待处理',
  'todo.panel.completed': '{n} 已完成',
  'todo.panel.expand': '展开任务列表',
  'todo.panel.collapse': '收起任务列表',
  'todo.panel.status.pending': '待处理',
  'todo.panel.status.in_progress': '进行中',
  ...
  'settings.modelsIntro': '配置提供方凭据与模型。官方 CodingPlan 模型由登录状态同步管理。',
  'settings.close': '关闭',
  ...
  'settings.fetchNeedsBaseUrl': '请先填写 Base URL，再获取模型',
  'settings.fetchEmpty': '该提供方没有返回可用模型，请手动填写',
  ...
  'settings.reasoningHistory': '思维链回传',
  'settings.reasoningHistoryAuto': '自动（按模型判定）',
  'settings.reasoningHistoryPreserve': '保留（有思考的轮才回传）',
  'settings.reasoningHistoryExclude': '不回传',
  'settings.reasoningHistoryHint':
    '是否把上一轮的思考过程回传给模型，保留思路、减少“想完就忘”。“保留”只在这一轮真有思考时才回传（无思考的轮不塞占位）。留“自动”按模型判定：DeepSeek-V4/Flash、Kimi 强制回传，GLM/Qwen 默认保留，其余不回传。',
  ...
  'settings.menuNotifications': '完成时通知',
  'settings.notifications.title': '浏览器完成通知',
  'settings.notifications.enabled': '任务完成后弹出浏览器通知',
  'settings.notifications.backgroundOnly': '仅后台标签页提醒（当前页面可见时不打扰）',
  'settings.notifications.minDuration': '最短回合时长（秒）',
  'settings.notifications.permissionGranted': '已授权：任务完成将在后台标签页弹出通知',
  'settings.notifications.permissionDefault': '尚未授权：请主动授权后启用浏览器通知',
  'settings.notifications.grantPermission': '授权浏览器通知',
  ...
  'settings.addCustomProvider': '添加自定义提供方',
  'settings.provider': '提供方',
  'settings.providerAccount': 'Provider 账号',
  'settings.models': '模型列表',
  'settings.reuseSavedApiKey': '复用已保存的 API Key，无需再次输入',
  'settings.noSavedApiKey': '该账号尚未配置 API Key',
  'settings.selectAtLeastOneModel': '请至少选择或输入一个模型',
  'settings.selectedModels': '已选择 {count} 个模型',
  'settings.alreadyAdded': '已添加',
  'settings.manualModel': '手动输入模型（可选）',
  'settings.defaultContextWindow': '默认上下文窗口',
  'settings.discoveredContextPreferred': '实时列表返回模型窗口时优先使用返回值',
  'settings.addSelectedModels': '添加所选模型',
  'settings.officialCodingPlan': '官方 CodingPlan',
  'settings.localProvider': '本地服务',
  ...
  'policyRecovery.completeDesc': '确认外部操作已完成，不自动调用模型。',
  'policyRecovery.skip': '跳过此步骤',
  'policyRecovery.skipDesc': '跳过认证步骤并结束本次恢复，不自动调用模型。',
  ...
  'policyRecovery.submitError': '无法提交安全恢复选择，请重试。',
  'policyRecovery.completedLocally': '已确认认证步骤在外部完成。为避免重新生成敏感命令，本次恢复未调用模型；你可以继续提交不涉及凭据的任务。',
  'policyRecovery.skippedLocally': '已跳过需要访问凭据的步骤。为避免重新生成敏感命令，本次恢复未调用模型；你可以继续提交其他安全任务。',
  'policyRecovery.endedLocally': '已结束本次安全恢复，未调用模型。',
  ...
  'cmd.context.body': '上下文：已用 {used} tokens（{pct}%）· 共 {msgs} 条消息 · 窗口 {window}（{name}）',
...
const en: Record<MsgKey, string> = {
  ...
  'sidebar.expandWorkspace': 'Expand workspace sessions',
  'sidebar.collapseWorkspace': 'Collapse workspace sessions',
  'sidebar.timeNow': 'now',
  'sidebar.timeMinutes': '{n}min',
  'sidebar.timeHours': '{n}h',
  ...
  'chat.kbdHintMobile': 'Enter for newline · Tap ↑ to send',
  'stats.counts': '{rounds} rounds · {tools} tools',
  'stats.duration': '{duration}',
  'stats.cacheHit': '{percent}% cached',
  'stats.tokens': '{input} tok in · {output} tok out',
  'chat.stop': 'Stop',
  'chat.send': 'Send',
  ...
  'chat.artifacts': 'Files',
  'chat.artifactOpenFailed': 'Could not open file: {msg}',
  ...
  'tool.args': 'Arguments',
  'tool.output': 'Output',
  'todo.panel.title': 'Tasks',
  'todo.panel.inProgress': '{n} in progress',
  'todo.panel.pending': '{n} pending',
  'todo.panel.completed': '{n} completed',
  'todo.panel.expand': 'Expand task list',
  'todo.panel.collapse': 'Collapse task list',
  'todo.panel.status.pending': 'Pending',
  ...
  'settings.modelsIntro': 'Configure provider credentials and models. Official CodingPlan models are managed by your login.',
  ...
  'settings.fetchNeedsBaseUrl': 'Enter a Base URL before fetching models',
  'settings.fetchEmpty': 'This provider returned no models; enter one manually',
  ...
  'settings.reasoningHistory': 'Reasoning history',
  'settings.reasoningHistoryAuto': 'Auto (per model)',
  'settings.reasoningHistoryPreserve': 'Preserve (echo turns that have it)',
  'settings.reasoningHistoryExclude': 'Exclude',
  'settings.reasoningHistoryHint':
    "Echo the prior turn's reasoning back to the model to keep its train of thought (less “think then forget”). Preserve echoes only turns that actually reasoned (no placeholder on non-thinking turns). Auto decides per model: DeepSeek-V4/Flash & Kimi require it, GLM/Qwen preserve, others exclude.",
  'settings.apiKey': 'API Key',
  ...
  'settings.notifications.title': 'Browser notifications',
  'settings.notifications.enabled': 'Show a browser notification when a task completes',
  'settings.notifications.backgroundOnly': 'Only in background tabs (no popup while this page is visible)',
  'settings.notifications.minDuration': 'Min turn duration (seconds)',
  'settings.notifications.permissionGranted': 'Granted: notifications appear when a task finishes in a background tab',
  'settings.notifications.permissionDefault': 'Not yet granted: explicitly allow browser notifications to enable alerts',
  'settings.notifications.grantPermission': 'Allow browser notifications',
  'settings.notifications.permissionDenied': 'Denied: allow notifications in your browser site settings and retry',
  ...
  'settings.providerAccount': 'Provider account',
  'settings.models': 'Models',
  'settings.reuseSavedApiKey': 'Reuses the saved API key; no need to enter it again',
  'settings.noSavedApiKey': 'This account has no saved API key',
  'settings.selectAtLeastOneModel': 'Select or enter at least one model',
  'settings.selectedModels': '{count} models selected',
  'settings.alreadyAdded': 'Added',
  'settings.manualModel': 'Manual model (optional)',
  'settings.defaultContextWindow': 'Default context window',
  'settings.discoveredContextPreferred': 'Uses the model-specific value returned by discovery when available',
  'settings.addSelectedModels': 'Add selected models',
  'settings.officialCodingPlan': 'Official CodingPlan',
  'settings.localProvider': 'Local service',
  ...
  'policyRecovery.completeDesc': 'Acknowledge external completion without calling the model.',
  'policyRecovery.skip': 'Skip this step',
  'policyRecovery.skipDesc': 'Skip the authenticated step and end recovery without calling the model.',
  ...
  'policyRecovery.submitError': 'Could not submit the security recovery decision. Please retry.',
  'policyRecovery.completedLocally': 'External completion acknowledged. To avoid regenerating sensitive commands, recovery did not call the model; you may now submit a task that does not involve credentials.',
  'policyRecovery.skippedLocally': 'The credential-dependent step was skipped. To avoid regenerating sensitive commands, recovery did not call the model; you may now submit another safe task.',
  'policyRecovery.endedLocally': 'Security recovery ended without calling the model.',
  ...
  'cmd.context.body': 'Context: {used} tokens used ({pct}%) · {msgs} messages · window {window} ({name})',
