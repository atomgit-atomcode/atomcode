...
const zh = {
  ...
  'settings.notifications.permissionDefault': '尚未授权：打开开关时将请求通知权限',
...
const en: Record<MsgKey, string> = {
  ...
  'settings.notifications.permissionDefault': 'Not yet granted: enabling the switch will request permission',
